...
export default class Edit extends Component{
    ...
    componentDidMount(){
        ...
        .then(response => {
            ...
            api.quiz.edit(this.props.match.params.id)
            .then(response => {

                this.setState({
                    title: response.data.title,
                    selectedQuestionSets: response.data.questionSets,
                });
            })
    ...
    save(){
        ...
        api.quiz.update(this.props.match.params.id, obj)
    ...
    tabRow(){
        ...
        return this.state.questionsets.map(function(object, i){
            ...
            return  (
                <tr key={i}>
                    <td>
                        <input type="checkbox" onChange={ (e) => that.onChangeSelectedQuestionSet(e, object._id)} checked={that.state.selectedQuestionSets.includes(object._id)} />
                    </td>
                    <td style={{width:'50%'}}>
                        {object.title}
                    </td>
